...
const LoadErros = ({erros}: {erros:string[]}) => {
    ...
    return (
        <>
            {
                listErros.length > 0 && (
                    <div className={`z-50 fixed w-full h-full left-0 top-0 flex items-center justify-center`}>
                        ...
                        <div className="absolute py-7 px-8 bg-white opacity-100 rounded-xl md:min-w-120 flex items-center flex-col text-md leading-5 mx-2">
                            <div className="w-full">
                                ...
                                <h2 className="font-bold mb-1"><span><i className="text-gray-400 pr-3 bi bi-tools"></i></span>Tente fechar e abrir novamente o site!</h2>   
                                <h2 className="font-bold mb-1"><span><i className="text-blue-600 pr-3 bi bi-telephone-fill"></i></span>Caso o erro continue, contate o TI!</h2> 
                                <h2 className="font-bold"><span><i className="text-green-600 pr-3 bi bi-whatsapp"></i></span>+55 (51) 93543-8615</h2>     
                            </div> 
                            <img
